...
export const employeePortalModules: EmployeePortalModuleDefinition[] = [
  ...
  { key: 'departments', label: 'Departments', description: 'Department codes, leads, sort order, and active/inactive administration.', phase: '003', status: 'audit-ready' },
  { key: 'positions', label: 'Positions & Roles', description: 'Position defaults plus role and permission group administration foundations.', phase: '003', status: 'audit-ready' },
